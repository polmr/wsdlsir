package net.sf.taverna.t2.activities.wsdlsir.security;
...
public class SecurityProfiles {
	...
	/**
	 * Security profile for Web services that require SAML WEB SSO PROFILE Authentication. 
	 * There is no WS-Security involved.
	 * Such services would typically be invoked over HTTPS.
	 */
	public static final String SAMLWEBSSOAUTH = "SAMLWebAuthN";
