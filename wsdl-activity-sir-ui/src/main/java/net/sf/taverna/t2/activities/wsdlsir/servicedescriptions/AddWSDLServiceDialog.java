...
public abstract class AddWSDLServiceDialog extends HelpEnabledDialog {
	...
	public AddWSDLServiceDialog()  {
		super(MainWindow.getMainWindow(), "Add WSDL FEDERATED service", true, null); // create a non-modal dialog
		initComponents();
	...
	private void initComponents() {
		...
		wsdlLocationField = new JTextField("http://somehost-in-a-federation/service?wsdl");
		gbc.weightx = 1.0;
		gbc.gridx = 1;
		gbc.gridy = 0;
