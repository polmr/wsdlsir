...
import net.sf.taverna.t2.activities.wsdlsir.HandlerConCookies;
import net.sf.taverna.t2.activities.wsdlsir.CallPreparator;
...
public class WSDLActivityConfigurationView extends HelpEnabledDialog implements ItemListener{
	...
	private JRadioButton SAMLSecurityAuthNRadioButton;
	private JLabel httpSecurityAuthNLabel;
	
	private JLabel SAMLSecurityAuthNLabel;
	...
	private JButton setSAMLGETCookieButton;
...
//		addDivider(noSecurityLabel, SwingConstants.BOTTOM, false);
		...
		ActionListener getCookieListener = new ActionListener() {
			public void actionPerformed(ActionEvent e)  {
				try
				{
					...
					{
						if (debug)
							System.out.println("Obtaining a SAML cookies to save in credential manager:"+endpoint); 
				...
				{
					System.err.println("Problem getting or saving SAML cookie: "+ newBean.getWsdl()+ ". "+ex.getMessage());
					ex.printStackTrace();
				}
	...
	private void okPressed() {
		...
		else if (SAMLSecurityAuthNRadioButton.isSelected()) {

			newBean.setSecurityProfile(SecurityProfiles.SAMLWEBSSOAUTH);
		}
 ...
 */
	 ...
	 * TODO: mover a algun sitio comun?
	 * @param o
	 * @return
	 * @throws IOException
	 */
