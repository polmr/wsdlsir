package net.sf.taverna.t2.activities.wsdlsir.servicedescriptions;
...
import net.sf.taverna.t2.activities.wsdlsir.WSDLActivityHealthChecker;
...
public class WSDLServiceProvider extends
	...
	private static final String WSDL_SERVICE = "WSDL FEDERATED service";
	...
	public WSDLServiceProvider() {
		super(new WSDLServiceProviderConfig("http://somehost/federatedservice?wsdl"));
	}
